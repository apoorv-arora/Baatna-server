	...
	public boolean updateWishedUsers(int userId, int type, int wishId ) {
		...
		try {
			...
			if (type == CommonLib.ACTION_ACCEPT_WISH) {
				...
				String sql3 = "INSERT INTO USERWISH (WISHID, USERID, WISH_STATUS, USER_TWO_ID,NEGOTIATION_STATUS,NEGOTIATION_AMOUNT) VALUES (:WISHID,:USERID,:WISH_STATUS,:USER_TWO_ID, :NEGOTIATION_STATUS,:NEGOTIATION_AMOUNT);";
